...
/**
 * Test if the attribute value of linked items (through linkCode), is lower or equals to the given number (value).
 * 
 * <p>
 ...
 */
public class LinkLowerThanCriteria extends AbstractLinkTestCriteria implements Cloneable {
	 ...
	 */
	public LinkLowerThanCriteria(String linkCode, String attribute, String value) {
	 ...
	 * @param value the constant value to test.
	 */
	public LinkLowerThanCriteria(String reference, String linkCode, String attribute, String value) {
	 ...
	 */
	public LinkLowerThanCriteria(String reference, String linkCode, String attribute, String value, boolean ignoreSubdivision, boolean deleted) {
		super(reference, linkCode, attribute, value, ignoreSubdivision, deleted);
	}

	public LinkLowerThanCriteria() {
		super();
	}

	@Override
	public boolean equals(Object obj) {
		return (obj instanceof LinkLowerThanCriteria) && super.equals(obj);
	}

	@Override
	public LinkLowerThanCriteria clone() {
		return new LinkLowerThanCriteria(getReference(), getLinkCode(), getAttribute(), getValue(), isIgnoreSubdivision(), isDeletedLinks());
	}
	...
	protected String getTestString() {
		return Messages.Criteria_LowerOrEqual;
	}
}
