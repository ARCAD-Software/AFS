...
/**
 * Test if the value of an attributes is lower or equals than the value of another one. 
 */
public class AttributeLowerOrEqualsCriteria extends AbstractSearchCriteria implements IAttributesCriteria {

	private String attribute;
	private String secondAttribute;

	public AttributeLowerOrEqualsCriteria() {
		super();
	}

	public AttributeLowerOrEqualsCriteria(String attribute1, String attribute2) {
		super();
	...
	public boolean equals(Object obj) {
		return (obj instanceof AttributeLowerOrEqualsCriteria) && //
				nullsOrEquals(attribute, ((AttributeLowerOrEqualsCriteria)obj).attribute) && //
				nullsOrEquals(secondAttribute, ((AttributeLowerOrEqualsCriteria)obj).secondAttribute);
	}
