...
public interface IMetaDataModifyListener {
	 ...
	 * 
	 * <p>
	 * Default implementation must return true. Returning false will cancel the operation.
	 * 
	 ...
	 */
	public boolean testModification(MetaDataEntity entity, BeanMap originalItem, BeanMap modifiedItem, List<MetaDataAttribute> attributes, IConnectionUserBean user, Language language) throws ResourceException;
