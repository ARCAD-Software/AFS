...
public class TokenMgrError extends Error
{
   ...
   /**
	 * 
	 */
	private static final long serialVersionUID = -1877028380196790542L;
   ...
   private static final String LexicalError(boolean EOFSeen, int lexState, int errorLine, int errorColumn, String errorAfter, char curChar) {
	  ...
	  if (EOFSeen) {
		 ...
		 s = "\"" + addEscapes(String.valueOf(curChar)) + "\""; //$NON-NLS-1$ //$NON-NLS-2$
	  }
      return String.format(Messages.TokenMgrError_LexicalError,
    		  errorLine,errorColumn,s,(int)curChar,addEscapes(errorAfter));
   }
