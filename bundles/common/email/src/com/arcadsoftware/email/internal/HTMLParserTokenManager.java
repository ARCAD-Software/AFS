...
public class HTMLParserTokenManager implements HTMLParserConstants {
	 ...
	 */
	/*
	 * private final int jjStartNfa_6(int pos, long active0) { return
	 * jjMoveNfa_6(jjStopStringLiteralDfa_6(pos, active0), pos + 1); }
	 */
	/*
	 ...
	 */
	/*
	 * private final int jjStartNfa_2(int pos, long active0) { return
	 * jjMoveNfa_2(jjStopStringLiteralDfa_2(pos, active0), pos + 1); }
	 */
	/*
	 ...
	 */
	/*
	 * private final int jjStartNfa_1(int pos, long active0) { return
	 * jjMoveNfa_1(jjStopStringLiteralDfa_1(pos, active0), pos + 1); }
	 */
	...
	private static final String[] jjstrLiteralImages = { "", null, null, "\74\41\55\55", "\74\41", null, null, null, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			null, null, null, null, null, "\75", null, null, "\47", "\42", null, null, null, null, null, null, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			"\55\55\76", null, "\76", }; //$NON-NLS-1$ //$NON-NLS-2$
	private static final int[] jjnewLexState = { -1, 1, 1, 5, 6, -1, -1, -1, -1, -1, -1, -1, -1, 2, 0, 1, 3, 4, -1, -1,
			1, -1, 1, -1, 0, -1, 0, };
	...
	public HTMLParserTokenManager(SimpleCharStream stream) {
		if (SimpleCharStream.staticFlag)
			throw new Error(Messages.HTMLParserTokenManager_InternalErrorUseStaticCharStream);
		input_stream = stream;
	}
	...
	public void SwitchTo(int lexState) {
		if (lexState >= 7 || lexState < 0)
			throw new TokenMgrError(Messages.HTMLParserTokenManager_InternalErrorInvalidLexicalState + lexState + Messages.HTMLParserTokenManager_StateUnchanged,
