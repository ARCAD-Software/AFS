...
public class Messages extends NLS {
	...
	public static String MapperSQLService_Attribute;
	public static String MapperSQLService_ConvertToBigInteger;
	public static String MapperSQLService_ConvertToFloat;
	public static String MapperSQLService_ConvertToInteger;
	public static String MapperSQLService_ConvertToLong;
	public static String MapperSQLService_ConvertToTimeStamp;
	...
	public static String MapperSQLService_ErrorGetLastDateOfModification;
	...
	public static String MapperSQLService_InternalSQLError;
