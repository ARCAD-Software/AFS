...
public abstract class AbstractAFSPropertySection extends AbstractPropertySection {
	...
	Hashtable<Text,TextModifyListener> textListeners;
	Hashtable<Button,ButtonSelectionListener> checkboxListeners;
	...
	public void createControls(Composite parent,
		...
		//Composite composite = getWidgetFactory().createFlatFormComposite(section);
