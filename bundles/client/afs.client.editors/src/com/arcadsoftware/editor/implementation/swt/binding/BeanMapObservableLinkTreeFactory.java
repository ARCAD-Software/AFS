...
public class BeanMapObservableLinkTreeFactory implements IObservableFactory {
	 ...
	 * @param fatherCode
	 */
	public BeanMapObservableLinkTreeFactory(SWTRenderer renderer, BeanMapObservableLink observableLink, String fatherCode) {
		super();
	...
	public IObservable createObservable(Object target) {
		if (target instanceof IIdentifiedBean) {
			...
			renderer.getRendererBinding().getBinding().bindList(result, observableLink, new TargettoModelTreeUpdateStrategy(cl), new ModeltoTargetTreeUpdateStrategy(observableLink,fatherCode,((IIdentifiedBean)target).getId(),cl));
			return result;
		}
		return null;
	}
