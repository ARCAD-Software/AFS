 ...
 * 
 *  <p>
 *  Theses elements correspond to the declared parameter into the extension point that define 
 *  the Widget Provider.
 */
public interface ILayoutParameters {
	...
	/**
	 * The associated action are accessible only to Containers. Input and Decorator
	 * providers can not have dependent Actions. Theses action can be ignored
	 * or transmit to the renderer that will add them to the global action list.
	 * 
	 * @return a possibly empty list of actions.
	 */
	public List<IActionElement> getActions();
	
	//public void addParameterToElementParameter(ElementParameter elementParameter, String key, String value); Nothing to do into the interface
