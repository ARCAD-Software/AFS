...
public interface IRendererBinding {
	...
	/**
	 * Populate the enumaration list. See <code>getObservableList</code> for
	 * details.
	 * 
	 * <p>
	...
	/**
	 * Get an IObservable usage with the <code>ContextBinding</code> to link a
	 * selection into an enumeration list.
	 * 
	 * <p>
	 * This list represent the whole enumeration list. It is updated only if the
	 * enumeration list is updated on the server.
	 * 
	 * <p>
	 * This list can be affected to a Viewer if the content provider of this
	 * viewer is an instance of
	...
	/**
	 * Populate the link list element. See <code>getObservableLink</code> for
	 * details.
	 * 
	 * <p>
	...
	/**
	 * Execute a Rihno (JavaScript) script. The list of attributes codes is the
	 * impacted attributes or links that may be used into the script.
	 * 
	 * @param elements
	 ...
	 *            The link to observe.
	 * @param autoPopulate
	 *            If true the list will be populate as soon as the first binding
	 *            need it. If false, le list will rest empty until
	 *            <code>populateLink</code> is called.
	 * @param attributeList 
	 * 			  a list of attributes that must be read. If null all the attributes defined in the metadata
	 *            will be read.	            
	 * @return An IObservableList implementation
	 * @see #getBinding()
	 */
	...
	/**
	 * Create a default Data binding between a Data element (attribute or list)
	 * and a widget.
	 * 
	 * @param element
	 * @param widget
