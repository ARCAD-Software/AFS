...
/**
 * Provide a SWT container factory. 
 * Each call to <code>create</code> method should create a container and proceed to layout this container
...
public interface IContainerSWTProvider {
	 ...
	 * 
	 * <p>To create the sub-widget the container must call the <code>renderer.createSubContainer(...)</code>
	 * method.  
	 * 
	 * @param renderer The SWT Renderer.
	 * @param parameters the parameter list as declared in the extension point
	 * @param isEmpty true if this container is empty.
