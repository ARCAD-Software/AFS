...
public class SearchParameterClause {
	...
	public final static String CRITERIA_VALUE_ELEMENT_CLOSE = CRITERIA_TAG_CLOSE_BEGIN + "value" + CRITERIA_TAG_OPEN_END;  //$NON-NLS-1$
	...
	/**
	 * This method adds the equals clause to the xml query 
	 * when <param>value</param> is a NOT String.
	 * When the method is called, <param>value</param> has to be cast into a String.
	 * 
	 * @param fieldName
	 * @param value
	...
	/**
	 * This method adds the equals clause to the xml query 
	 * when <param>value</param> is a String.
	 * 
	 * @param fieldName
	 * @param value
	 * @return the clause under a xml form
