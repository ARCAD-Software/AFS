...
public interface ISWTRenderer extends IBeanMapSelector {
	 ...
	 */
	public void createSubContainer(IContainerSWTProvider parentProvider, ILayoutParameters parameters, Composite parent);
	 ...
	 * 
	 * <p>
	 * This method can return null if the referenced entity can not be loaded, or if the
	 * element is an attribute with a atomic type (string, integer, ...).
	 * 
	 * @param element
	 ...
	 * @param code
	 *            The attribute code.
	 * @param conditionnedBy (attribute)
	 * 			  The value of the beanmap given by <b>code</b>
	 *            will be mandatory if the value of the beanmap given
	 *            by <b>conditionnedBy</b> is true.
	 */
	 ...
	 * 
	 * <p>
	 * The renderer set some default parameters (source entity, current edited item and so on...) 
	 * the given parameters will override these parameters.
	 * 
	 * @param string
	 * @param parameters
