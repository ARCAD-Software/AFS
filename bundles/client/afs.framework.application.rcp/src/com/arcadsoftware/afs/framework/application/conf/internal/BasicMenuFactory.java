...
public class BasicMenuFactory extends AbstractBasicMenuFactory {
	...
	public void createFileSubMenu(IActionRegister actionBarAdvisor, MenuManager fileMenu) {
		final IWorkbenchWindow windows = actionBarAdvisor.getWorkbenchWindow();
		if (isMenuVisible(IMENUConst.FILE_NEW)) {
			final MenuManager newMenu = new MenuManager(getMenuLabel(IMENUConst.FILE_NEW), ActionFactory.NEW.getId());
		...
		addMenu(IMENUConst.FILE_REOPENEDITORS, actionBarAdvisor, fileMenu, windows,
	...
	public void createWindowSubMenu(IActionRegister actionBarAdvisor, MenuManager windowMenu) {
		...
		if (isMenuVisible(IMENUConst.WINDOW_OPEN_PERSPECTIVES)) {
			final MenuManager menuPerspective = new MenuManager(getMenuLabel(IMENUConst.WINDOW_OPEN_PERSPECTIVES),
					ActionFactory.OPEN_PERSPECTIVE_DIALOG.getId());
		...
		if (isMenuVisible(IMENUConst.WINDOW_OPEN_VIEWS)) {
			final MenuManager menu_show_view = new MenuManager(getMenuLabel(IMENUConst.WINDOW_OPEN_VIEWS),
					ActionFactory.SHOW_VIEW_MENU.getId());
		...
		addMenu(IMENUConst.WINDOW_RESET_PERSPECTIVE, actionBarAdvisor, windowMenu, windows,
