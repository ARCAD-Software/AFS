...
public abstract class AbstractConfigurationManager implements IConfigurationManager {
	...
	private final HashMap<String, String> visibleMenus;
	 ...
	 *
	 * @param perspectiveBarVisible
	 *            Indicates the visibility of the perspective bar
	 */
	 ...
	 *
	 * @param statusLineVisible
	 *            Indicates the visibility of the status Line
	 */
	 ...
	 *
	 * @param coolBarVisible
	 *            Indicates the visibility of the Cool Bar
	 */
	 ...
	 *            Indicates the visibility of the Progress Bar
	 */
	 ...
	 *
	 * @param fastViewBarVisible
	 *            Indicates the visibility of the FastView Bar
	 */
	 ...
	 * This method must be override if you want to change the default value that is
	 ...
	 * This method must be override if you want to change the default value that is false.
	 *
	 * @return
	 */
	 ...
	 *
	 * @param location
	 *            a location constants defined in IWorkbenchPreferenceConstants
	...
	public String getMenuLabel(String menuId) {
		final String value = visibleMenus.get(menuId);
		if (value != null) {
	 ...
	 * - The key is a unique identifier of a menu item - the value is the label of this menu item.
	 * </p>
	 *
	 * @param visibleMenus
	 */
	...
	/**
	 * Allow to define witch Action Set Extension will be used. Override this method to define which Actions will be
	 * used.
	 * <p>
