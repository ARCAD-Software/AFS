...
public class LogTools {
	...
	protected static BundleProperty[] BUNDLE_PROPERTIES = 
		new BundleProperty[]{BundleProperty.ID, BundleProperty.NAME,BundleProperty.VENDOR,BundleProperty.VERSION} ;
	

	public static String getBundleSummaryInformation(Bundle bundle, BundleProperty[] keys, boolean showLabel) {
		StringBuilder info = new StringBuilder();
	    for (BundleProperty bp:keys) {	    	
	    	Object o = bundle.getHeaders().get(bp.key);
	    	if (o!=null) {
	...
	*/
	public static Status createStatus(Bundle bundle, int severity, String msg) {
	    Status status = new Status(severity, bundle
