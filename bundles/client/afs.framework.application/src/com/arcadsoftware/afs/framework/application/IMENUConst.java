...
public interface IMENUConst {
	...
	public static String FILE_CLOSEALL = "/file/closeall"; //$NON-NLS-1$
	public static String FILE_SAVE = "/file/save"; //$NON-NLS-1$
	public static String FILE_SAVEAS = "/file/saveas"; //$NON-NLS-1$
	public static String FILE_SAVEALL = "/file/saveall"; //$NON-NLS-1$
	public static String FILE_REVERT = "/file/revert"; //$NON-NLS-1$
	public static String FILE_MOVE = "/file/move"; //$NON-NLS-1$
	public static String FILE_RENAME = "/file/rename"; //$NON-NLS-1$
	public static String FILE_REFRESH = "/file/refresh"; //$NON-NLS-1$
	public static String FILE_IMPORT = "/file/import"; //$NON-NLS-1$
	public static String FILE_EXPORT = "/file/export"; //$NON-NLS-1$
	...
	public static String EDIT_CUT = "/edit/cut"; //$NON-NLS-1$
	public static String EDIT_COPY = "/edit/copy"; //$NON-NLS-1$
	public static String EDIT_PAST = "/edit/paste"; //$NON-NLS-1$
	public static String EDIT_DELETE = "/edit/delete"; //$NON-NLS-1$
	public static String EDIT_SELECTALL = "/edit/selectall"; //$NON-NLS-1$
	...
	public static String HELP_SEARCH = "/help/search"; //$NON-NLS-1$
	public static String HELP_DYNAMIC = "/help/dynamic"; //$NON-NLS-1$
	public static String HELP_ABOUT = "/help/about"; //$NON-NLS-1$
}
