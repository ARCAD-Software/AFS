 ...
 *******************************************************************************/
package com.arcadsoftware.afs.client.users.internal;
...
public class Activator extends AbstractAFSUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.arcadsoftware.afs.client.users"; //$NON-NLS-1$
	public static final String BUNDLE_ID = Activator.class.getPackage().getName() + ".resources"; //$NON-NLS-1$
