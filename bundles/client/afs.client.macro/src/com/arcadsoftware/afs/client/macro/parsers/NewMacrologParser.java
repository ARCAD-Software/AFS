	        	...
	        	if(eventType == XmlPullParser.START_TAG) {
	        		...
	        		if (tag.equals(ITEM_MACRO)) {
	        			if (parser.getAttributeCount()==3) {
	        				String macroLibrary = parser.getAttributeValue(0).trim();
	        				String macroName = parser.getAttributeValue(1).trim();
	        		...
	        		if (tag.equals(ITEM_LOG)) {
	        			...
	        			if (parser.getAttributeCount()==count) {
	        				...
	        				String sequence = parser.getAttributeValue(1);
	        				String severity = parser.getAttributeValue(2).trim();
	        				String status = parser.getAttributeValue(3).trim();
	        				String type = parser.getAttributeValue(4).trim();	        				
