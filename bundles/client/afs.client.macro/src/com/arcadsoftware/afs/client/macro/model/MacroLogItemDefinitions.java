...
public class MacroLogItemDefinitions extends ArrayList<MacroLogItemDefinition> {
	...
	public static MacroLogItemDefinitions fromXml(String macrolibrary, String macroname, File xmlFile,
			IMacrologParser... parsers) {
	...
	private static MacroLogItemDefinitions fromXml(String macrolibrary, String macroname, Reader reader,
			IMacrologParser... parsers) {
		final MacroLogItemDefinitions macros = new MacroLogItemDefinitions(macrolibrary, macroname);
