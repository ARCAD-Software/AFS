# AFS-OS release version 2023.7.26.

Release date Tue Jul 02 16:38:41 CEST 2024.

Link to the update site of [Version 2023.7.26](https://github.com/ARCAD-Software/AFS/releases/download/2023.7.26/).

10 Bundles modified in this release.
...
[com.arcadsoftware.groovy.security](bundles/common/groovy.security) | **Upgraded** from version 1.1.3 | **1.1.4**
[com.arcadsoftware.metadata](bundles/common/metadata) | **Upgraded** from version 1.5.8 | **1.5.9**
[com.arcadsoftware.osgi](bundles/common/osgi) | **Upgraded** from version 1.9.4 | **1.9.5**
...
Bundle Symbolic Name | Modification | Version
-------------------- | ------------ | -------
[com.arcadsoftware.database.sql](bundles/server/database.sql) | **Upgraded** from version 2.3.5 | **2.3.6**
...
[com.arcadsoftware.metadata.binary](bundles/server/metadata.binary) | **Upgraded** from version 1.2.4 | **1.2.5**
...
[com.arcadsoftware.metadata.rest](bundles/server/metadata.rest) | **Upgraded** from version 1.4.5 | **1.4.6**
...
[com.arcadsoftware.server.binaries](bundles/server/server.binaries) | **Upgraded** from version 1.2.4 | **1.2.5**
...
[com.arcadsoftware.server.restful.connection.local](bundles/server/server.restful.connection.local) | **Upgraded** from version 1.5.5 | **1.5.6**
[com.arcadsoftware.server.restful.console](bundles/server/server.restful.console) | **Upgraded** from version 1.4.3 | **1.4.4**
[com.arcadsoftware.server.restful.layouts](bundles/server/server.restful.layouts) | **Upgraded** from version 9.6.3 | **9.6.4**
